...
const Admin = () => {
  ...
  const onSubmit = (data) => {
    fetch("https://tourism-service-server-rafiulalam98.vercel.app/admin", {
      method: "POST",
      headers: {
    ...
    <Container fluid className="container-body">
      <Row className="service-container">
        ...
        <Col xs={12} md={12} lg={12} className="mb-5 mt-2">
          <form
            className="d-flex flex-column mt-5 justify-content-center mx-auto p-5 px-5  form-container"
          ...
          >
            ...
            <input
              className="mb-3"
              placeholder="Deparature"
              {...register("deparature", { required: true })}
            />
